...
import MapFeaturesRow from "./map_features_table";
...
const tablesSchema = __schema({
  entity: __table({
    ...
    indexes: [
      ...
      { accessor: 'game_id', name: 'entity_game_id_idx_btree', algorithm: 'btree', columns: [
        'gameId',
      ] },
    ],
    constraints: [
  ...
  game_rules: __table({
    name: 'game_rules',
    indexes: [
      { accessor: 'game_id', name: 'game_rules_game_id_idx_btree', algorithm: 'btree', columns: [
        'gameId',
      ] },
    ],
    constraints: [
      { name: 'game_rules_game_id_key', constraint: 'unique', columns: ['gameId'] },
    ],
  }, GameRulesRow),
  map_features: __table({
    name: 'map_features',
    indexes: [
      { accessor: 'game_id', name: 'map_features_game_id_idx_btree', algorithm: 'btree', columns: [
        'gameId',
      ] },
    ],
    constraints: [
      { name: 'map_features_game_id_key', constraint: 'unique', columns: ['gameId'] },
    ],
  }, MapFeaturesRow),
  player: __table({
    name: 'player',
    indexes: [
      { accessor: 'game_id', name: 'player_game_id_idx_btree', algorithm: 'btree', columns: [
        'gameId',
      ] },
